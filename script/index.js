function RedirectArticle() {
    //doit etre changé pour le lien vers la page ou l'article selectionné est détaillé 
...
function ShowArticle() {
    ...
    Texte.innerText = ContenuArticle;
...
//execute la fonction show article X fois (ici en ex: 2)
var X = 2
for (i = 1; i <= X; i++) {
    ShowArticle()
}